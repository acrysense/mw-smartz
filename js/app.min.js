  ...
  if (optionsList) {
    optionsList.forEach(function (option) {
      option.addEventListener('click', function (event) {
        ...
        if (parent.classList.contains('select-box--single')) {
          ...
          if (option.querySelector('input').checked) {
            ...
            var currentArray = currentSelectedValue.innerHTML.split(', ');
            if (currentArray.length > 1) {
              var deleteIndex = currentArray.indexOf(option.querySelector('.select-box__label').innerHTML);
              var newArray = currentArray.splice(deleteIndex, 1);
              currentSelectedValue.innerHTML = currentArray.join(', ');
            } else {
              if (!currentSelectedPlaceholder.classList.contains('select-box__placeholder--active')) {
